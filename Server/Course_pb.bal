...
public client class CourseManagementTheRespondCaller {
    ...
    isolated remote function sendTheRespond(theRespond response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextTheRespond(ContextTheRespond response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public client class CourseManagementMyCourseCaller {
    private grpc:Caller caller;
    ...
    isolated remote function sendMyCourse(myCourse response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextMyCourse(ContextMyCourse response) returns grpc:Error? {
        return self.caller->send(response);
    }
